...
public class HttpClientTpl {
    ...
    public static String post(String url, String[][] params) throws Exception {
        return (String)execute(url,true,params,stringProcessor);
    }

    public static String get(String url) throws Exception {
        return (String)execute(url,false,null, stringProcessor);
    }

    public static Object post(String url, String[][] params, Processor processor) throws Exception {
        return execute(url,true,params,processor);
    }

    public static Object get(String url, Processor processor) throws Exception {
        return execute(url,false,null, processor);
    }

    static Object execute(String url, boolean post,String[][] params, Processor processor) throws Exception{
